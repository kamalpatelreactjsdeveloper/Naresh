                ...
                <div className=" md:w-1/2 xs:order-2">
                    <div className=" space-y-4 xs:pt-6 xs:pb-10  ">
                        ...
                        <div className="xl:text-[28px] lg:text-[20px] md:text-[16px] xs;text-[16px] xl:leading-[28px] lg:leading-[22px]  md:leading-[16px] text-medium text-left font-sans xl:pl-[145px] lg:pl-[100px] md:pl-[60px]" style={{ color: '#f9f8f5' }}>
                            ...
                            <p className="xl:pt-10 lg:pt-5 md:pt-3 ">
                                We are a high-quality manufacturer of <br /> admixtures and precast. These<br /> components are carefully measured <br />and mixed in specific proportions to <br />achieve the desired chemical and <br />physical properties.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className=" space-y-4 pt-[20px] xs:py-10 ">
                        ...
                        <div className=" xl:text-[28px] lg:text-[20px] md:text-[16px] xs:text-[16px] xl:leading-[28px] lg:leading-[22px]  md:leading-[16px] text-medium text-left font-sans xl:pl-[145px] lg:pl-[100px] md:pl-[60px]" style={{ color: '#f9f8f5' }}>
                            <p className=" space-x-0 pt-4 md:pt-2">
                                ...
                                mortar. We also have a manufacturing <br/> unit for jointing Mortar. This is an <br/> add-on with AAC blocks.
                            </p>
                ...
                <div className=" md:w-1/2 xl:pb-[100px]">
                    <div className=" space-y-4 xl:pt-20 lg:pt-0 xs:py-10">
                        ...
                        <div className="xl:text-[28px] lg:text-[20px] md:text-[16px] xs:text-[16px] xs:pl-[50px] xl:leading-[32px] lg:leading-[22px] md:leading-[16px] font-thin text-left font-sans xl:pl-[145px] lg:pl-[100px] md:pl-[60px]" style={{ color: '#f9f8f5' }}>
                            <p className=" space-x-0 xl:pt-8 lg:pt-4">
                                Naresh Enterprise also steps into the<br/>
                                waterproofing chemicals. Water leakage <br/> is a very serious problem in construction,<br/> which is why we came into existence.<br/>
                                Our manufacturing plant is located in <br/> Vapi. Our water-proofing chemicals <br/>
                                are designed with precision and <br/> unparalleled craftsmanship, they cover <br/> everything in water proofing.
                            </p>

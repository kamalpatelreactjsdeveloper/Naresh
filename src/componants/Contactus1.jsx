...
const Contactus1 = () => {
    return (
        <div>
            <div>
                <div className="flex flex-col md:flex-row items-center md:justify-between px-10 xl:py-20 lg:py-14 pb-0 xs:pt-4 bg-white min-h-screen">
                    <div className="w-full md:w-1/2 text-left mb-10 lg:mb-0">
                        <p className="xl:text-[80px] lg:text-[50px] md:text-[40px] xs:text-[40px]  pl-[30px] font-bold text-customtext">THANK YOU</p>
                        <p className="italic  pl-[40px] xl:text-[40px] lg:text-[25px] md:text-[18px] xs:text-[18px] xl:mt-[-20px]">
                            you for showing interest in
                        </p>
                        <p className="italic font-semibold xl:text-[28px] lg:text-[18px] md:text-[13px] xs:text-[13px] xl:mt-[-15px] lg:mt-[-6px] text-black pl-[38px]">
                            SDEKAY INFRA MARKET PRIVATE LIMITED.
                        </p>
                    </div>

                    <div className="w-full md:w-1/2 xl:p-[50px]">
                ...
                <div>
                    <img className='xl:h-[300px] md:h-[200px]  w-[100%] xl:mt-[-300px] lg:mt-[-150px] md:mt-[-100px]'
                        src={images11}
                    />
                </div>
            </div>
            <section className="flex flex-col items-center py-12 bg-white pb-[100px]">
                ...
                <div className="flex flex-col md:flex-row md:space-x-8 mt-8 justify-between">
                    ...
                    <div className="flex flex-col items-center mt-6 md:mt-0 md:w-[33%]">
                        <span className="material-icons xl:text-[50px] lg:text-[40px] md:text-[30px] xs:text-[30px]"><FontAwesomeIcon icon={faLocationDot} /> </span>

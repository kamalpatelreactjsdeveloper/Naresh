...
const About1 = () => {
    ...
    return (
        <div>
            <div className="bg-customtext ">
                <div className="2xl:max-w-[1440px] mx-auto flex flex-col md:flex-row bg-customtext text-white xs:pb-[50px]">
            ...
            <section className="2xl:max-w-[1440px] mx-auto flex flex-col md:flex-row items-center  w-full py-12 lg:py-0 px-6 lg:px-20 bg-white">
            ...
            <section className="2xl:max-w-[1440px] mx-auto flex flex-col md:flex-row items-center  w-full py-12 lg:py-0 px-6 lg:pb-0 lg:px-20">
            ...
            <section className="relative w-full h-auto py-16">
                ...
                <div className="2xl:max-w-[1440px]  relative z-10 container  mx-auto px-6 lg:px-20 text-center text-white">
                    <div className='leading-[50px] xl:leading-[100px] lg:leading-[80px]'>
                    ...
                    <div className=" p-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
                            ...
                            <div className="flex flex-col items-center leading-[20px]">
                                <div>
                                    <img src={Image1} alt="Mission Illustration" className="w-100 h-full" />
                                </div>
                                <div className="text-7xl xs:text-5xl font-bold">{clients}</div>
                                ...
                                <div className="flex space-x-4 mt-4">
                                    ...
                                    <button
                                        className="bg-gray-800 px-4 py-2 rounded"
                                        onClick={() => setClients(clients > 0 ? clients - 1 : 0)}
                                    >
                                        -
                                    </button>
                                </div>
                            ...
                            <div className="flex flex-col items-center">
                                <div>
                                    <img src={Image2} alt="Mission Illustration" className="w-100 h-full" />
                                </div>
                                <div className="text-7xl font-bold xs:text-5xl">{vehicles}</div>
                                ...
                                <div className="flex space-x-4 mt-4">
                                    ...
                                    <button
                                        className="bg-gray-800 px-4 py-2 rounded"
                                        onClick={() => setVehicles(vehicles > 0 ? vehicles - 1 : 0)}
                                    >
                                        -
                                    </button>
                                </div>
                            ...
                            <div className="flex flex-col items-center">
                                <div>
                                    <img src={Image3} alt="Mission Illustration" className="w-100 h-full" />
                                </div>
                                <div className="text-7xl font-bold xs:text-5xl">{capacity}</div>
                                ...
                                <div className="flex space-x-4 mt-4">
                                    ...
                                    <button
                                        className="bg-gray-800 px-4 py-2 rounded"
                                        onClick={() => setCapacity(capacity > 0 ? capacity - 1 : 0)}
                                    >
                                        -
                                    </button>
                                </div>
            ...
            <section className="2xl:max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between w-full  py-16 px-8 lg:px-10 mb-5 pb-0 xs:pr-[5px]">

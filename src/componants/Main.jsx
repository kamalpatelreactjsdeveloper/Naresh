        ...
        <>
            <section className=" flex flex-col xs:flex-col-reverse   md:flex-row items-center md:py-0 lg:py-8" id="hero">
                <div className=" text-center md:mt-[100px] lg:mt-[101px] xl:mt-[126px] 2xl:mt-[88px] 3xl:mt-[88px] 3xl:w-[900px] md:text-left">
                    ...
                    <p className="xl:ml-20 lg:ml-14 md:ml-8 xs:ml-4 text-gray-700 py-4 lg:text-lg 3xl:text-3xl xl:text-xl md:text-sm xs:text-lg xs:text-start">Building a foundation for the future while honoring the values of today. Our vision is to build a world that balances progress and heritage.
                    ...
                    <br className='md:hidden lg:block' />
                    <br />
                    <img className='3xl:ml-0 3xl:w-[900px] 3xl:h-[250px] 2xl:h-[160px]  xl:h-[130px] xl:pt-[5px]  md:h-[117px] md:pb-[50px] lg:pb-0 lg:h-[80px] w-full' src={logo2} />
                </div>
                ...
                <div className="3xl:w-[850px] 3xl:h-[910px]  xl:h-[810px] lg:h-[610px] md:h-[449px] mt-[2px] bg-custombg text-white  text-start">
                    ...
                    <div className="xl:mt-4 lg:mt-4 md:mt-1 xs:mt-2">
                        <div className="border-b border-white xl:py-4 lg:py-3 md:py-2 xs:py-2 lg:pt-4 xs:pt-3 text-start xl:pt-8 md:pt-2">
                            ...
                            <p className="3xl:text-[28px] xl:text-xl lg:text-base md:text-xs 3xl:mt-4 xl:mt-2 xl:ml-8 lg:ml-8 md:ml-6 xs:ml-4">At SCRMC quality is the highest priority. Achieving customer satisfaction through ensuring the best quality is our goal.</p>
                        </div >
                        ...
                        <div className="border-b border-white xl:py-4 lg:py-3 md:py-2 xs:py-2 lg:pt-4 md:pt-2 xs:pt-3 xl:pt-8">
                            ...
                            <p className="3xl:text-[28px] xl:text-xl lg:text-base md:text-xs 3xl:mt-4 xl:mt-2 xl:ml-8 lg:ml-8  md:ml-6 xs:ml-4">Considering the structural requirements, we provide customized concrete solutions.</p>
                        </div>
                        <div className="xl:py-4 xs:pt-2 lg:py-3  md:py-2 xs:py-2">
                            ...
                            <p className="3xl:text-[28px] xl:text-xl lg:text-base md:text-xs 3xl:mt-4 xl:mt-2 lg:mt-2 xl:ml-8 lg:ml-8  md:ml-6 xs:ml-4">With dedicated equipment and large transit mixer fleet, Naresh Enterprises can support any large projects.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="pt-14 text-center">
                ...
                <img className="w-[100%] h-[150px]" src={logo2} alt="shadow" />
            </section>
